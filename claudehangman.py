...
def play_hangman():
    ...
    This procedure implements an algorithm that includes sequencing,
    selection and iteration - REQUIREMENT #1
    """
    print("\n===== WELCOME TO HANGMAN =====")
...
def main():
    ...
    This function calls the student-developed procedure - REQUIREMENT #2
    """
    play_game = True
    
    while play_game:
        play_hangman()  # Calling the student-developed procedure
